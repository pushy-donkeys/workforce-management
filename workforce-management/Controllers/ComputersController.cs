...
namespace workforceManagement.Controllers
{
    public class ComputersController : Controller
    {
        ...
        public ComputersController(workforceManagementContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("ComputerId,CommissionDate,Make,Manufacturer")] Computer computer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ComputerId,CommissionDate,Make,Manufacturer")] Computer computer)
        {
